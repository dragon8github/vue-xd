...
<script type="text/babel">
  ...
  import translateUtil from './translate.js';
  ...
  export default {
    ...
    mounted() {
      /* 李钊鸿添加的代码： */
      this.myItemHeight = this.itemHeight / this.$store.getters.fontSize + 'rem'
