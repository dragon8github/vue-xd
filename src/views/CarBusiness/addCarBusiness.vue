<template>
  <div class="content" id="addCarBusiness">
      <bsnheader :headerTitle="'添加车易贷业务'" :has-back='true'></bsnheader>
      <div class="page-field" v-if="myData">
            <div class="page-part">
                ...
                <mt-field label="受理日期" :star="true" type="text" @textClick="openPicker" :readonly = 'true' :value="formModel.inputTime"> </mt-field>

                <mt-field label="业务类型" type='other'>
      ...
      saveData () {
        ...
        this.api.Common.CommonApi_SaveBusinessBaseInfo({
            ...
            if (result.ReturnCode === 1) {
                this.$router.push('/carBusiness');
            }
        });
      }
    },
    beforeMount () {
      this.api.Common.CommonApi_InputBusiness('car').then(Result => {
